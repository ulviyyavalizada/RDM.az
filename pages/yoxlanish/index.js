...
import innerImg from "../../public/img/checkUp.png"
...
const CheckUp = ()=> {
    ...
    return(
        <section className="checkUp_inner">
                        ...
                        <div className="inner_container">
                            ...
                            <div className="inner_bottom">
                                ...
                                <div className="main_btn">
                                    <button className="outline_lightBlue" onClick={() => setApplyOpen(true)}>
                                        İndi qəbula yazıl
                                    </button>
                                </div>
                            </div>
            ...
            {applyOpen && <ApplyModal setApplyOpen={setApplyOpen} setSuccessOpen={setSuccessOpen}/>}
            {successOpen && <SuccessModal setSuccessOpen={setSuccessOpen}/>}
        </section>
    )
}
