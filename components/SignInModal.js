            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal_body">
                        ...
                        <form id="login_form">
                            <div className="form-group">
                                <input className="inputValidate" id="loginName" type="text" name="" required/>
                                <label className="place-label" htmlFor="loginName">Ad </label>
                            ...
                            <div className="form-group">
                                <input className="inputValidate" id="loginPassword" type="password" name="" required/>
                                <label className="place-label" htmlFor="loginPassword">Şifrə</label>
                                <span className="_star">
                                    <svg width="7" height="6" viewBox="0 0 7 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0.716507 5.04421L1.97756 3.18129L0 2.55076L0.372583 1.34703L2.3788 2.12086L2.29282 0H3.75449L3.66851 2.12086L5.67473 1.34703L6.04731 2.55076L4.06976 3.18129L5.35947 5.04421L4.27038 5.76071L3.03799 3.84047L1.77694 5.76071L0.716507 5.04421Z" fill="#80D4D4"/>
                                    </svg>
                    ...
                    <div className="modal_footer">
                        <button className="blue_btn">Daxil ol</button>
                        <p className="_text">
                            Hesabınız yoxdursa,
                            <span onClick={() => { 
                                    setSignUpOpen(true)
